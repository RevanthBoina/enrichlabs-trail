import { siNotion, siHubspot, siFigma, siLinear, siZapier, siGoogleads, siIntercom, siShopify, siInstagram, siReddit, siWhatsapp } from "simple-icons";
...
const iconMap: Record<string, { svg: string; hex: string }> = {
  ...
  pipedrive: { svg: pipedriveSvg, hex: "FF6600" }, // Pipedrive orange
