...
const pipedriveSvg =
  '<path d="M12 2L4 6v12l8 4 8-4V6l-8-4zm0 2.18l6 3v9.64l-6 3-6-3V7.18l6-3zm0 3.64L8.5 13.5 12 16l3.5-2.5L12 10.82zm-4 2.36v6.5l3.5-2.5 3.5 2.5v-6.5l-3.5 2.5-3.5-2.5z"/>';
// Generic API icon
const apiSvg =
  '<path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L19 7.5v7L12 18.5 5 14.5v-7l7-3.32zM12 8a2 2 0 100 4 2 2 0 000-4zm-4 6l8-3v2l-8 3v-2zm8 1l-8 3v-2l8-3v2z"/>';
// Webhook icon
const webhookSvg =
  '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>';
// Teams icon
const teamsSvg =
  '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-9c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm4 0c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1zm2 3c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z"/>';
// Gmail icon
const gmailSvg =
  '<path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>';
// Google Drive icon
const driveSvg =
  '<path d="M12 2L4 8.5l8 5 8-5L12 2zm0 8.5L6.5 7 12 3.5 17.5 7 12 10.5zM6 17.5l6-3.5 6 3.5 6-3.5L12 21l-6-3.5z"/>';
// Airtable icon
const airtableSvg =
  '<path d="M17.5 2H6.5c-.8 0-1.5.7-1.5 1.5v17c0 .8.7 1.5 1.5 1.5h11c.8 0 1.5-.7 1.5-1.5V3.5c0-.8-.7-1.5-1.5-1.5zM12 17c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm5-3.5c0 .6-.4 1-1 1H8c-.6 0-1-.4-1-1v-7c0-.6.4-1 1-1h8c.6 0 1 .4 1 1v7z"/>';
// Calendly icon
const calendlySvg =
  '<path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2zm-7 5l-4 4h8l-4-4z"/>';
// Shopify icon
const shopifySvg =
...
// Stripe icon
const stripeSvg =
  '<path d="M13.5 2c-2.5 0-4.5.2-6 .5 0 .1-.1.3-.1.5 0 .2.1.4.2.5 1.2.5 2.5.8 3.8.9.1 0 .2.1.2.2v1.4c0 .1-.1.2-.2.2-1.2 0-2.4-.3-3.5-.8-.1-.1-.2-.1-.3 0-1.1.6-2.4.9-3.7.9-.4 0-.8 0-1.2-.1-.1 0-.3.1-.3.2v.9c0 .1.1.2.2.2 1.4.1 2.7.1 4-.1 1.8-.3 3.4-1 4.8-2 .1-.1.3-.1.4 0 1.3 1.1 2.9 1.7 4.6 1.9.4.1.8.1 1.2.1.8 0 1.5-.1 2.2-.3.1 0 .2-.1.3-.2 0 0 .1-1.5.1-1.5 0-.2-.1-.4-.2-.5-.8-.4-1.7-.6-2.7-.7-.1 0-.2-.1-.2-.2V7.1c0-.1.1-.2.2-.2 1.3 0 2.6.2 3.8.7.1.1.2.1.3 0 .8-.6 1.7-1 2.6-1.3.1 0 .2-.1.3-.2.1-.2.1-.4 0-.6 0 0-.4-1.5-.5-1.9-.1-.2-.3-.3-.5-.3-.6.1-1.2.2-1.7.3-.3.1-.6.1-.9.2-.2.1-.4.2-.6.4-.2.2-.4.5-.3.8 0 .3.1.5.3.6.3.2.7.3 1.1.3h.1c.1 0 .2.1.2.2v.5c0 .1-.1.2-.2.2h-.1c-.6 0-1.2-.1-1.8-.3-.1 0-.2 0-.3.1 0 0-1.2.5-1.2.5-.1 0-.2.1-.3.1z"/>';
// Salesforce icon
const salesforceSvg =
  '<path d="M10.5 2c-2.5 0-4.5 2-4.5 4.5 0 1.6.8 3 2 3.9-.1.5-.2 1-.2 1.5 0 .3 0 .6.1.9.3.1.6.2.9.2 1.5 0 2.7-1.2 2.7-2.7 0-.5-.1-.9-.3-1.3.3-.1.5-.2.8-.3.2-.1.3-.4.2-.6-.1-.2-.4-.3-.6-.2-.7.3-1.4.4-2.2.4-.1 0-.2.1-.2.2v2.7c0 .1.1.2.2.2h.2c1 0 1.8-.8 1.8-1.8 0-.4-.1-.7-.3-1 .1 0 .1-.1.2-.1 1.2 0 2.2-1 2.2-2.2 0-1.2-1-2.2-2.2-2.2-.1 0-.2.1-.2.2v.3c0 .1-.1.2-.2.2z"/>';
// Meta icon
const metaSvg =
  '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.9 14.3c-.4.9-1 .9-1.8.9h-2.2c-.8 0-1.4 0-1.8-.9-.3-.6-.4-1.3-.4-2.3V10.5h2.2v3.5c0 .3 0 .5.1.7.2.9.8.9 1.7.9h2.2c.9 0 1.5 0 1.7-.9.1-.2.1-.4.1-.7V10.5h2.2v3.5c0 1-.1 1.7-.4 2.3z"/>';
// X (Twitter) icon
const xSvg =
  '<path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>';
// Make (Integromat) icon
const makeSvg =
  '<path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18L18.36 7 12 9.82 5.64 7 12 4.18zM4 8.82l7 3.5v7.36l-7-3.5V8.82zm9 10.86v-7.36l7-3.5v7.36l-7 3.5z"/>';
// n8n icon
const n8nSvg =
